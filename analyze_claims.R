...
Fn_Analyze_Claims <- function(raw_claims_file = "data/nfip_claims_raw.txt", 
                              output_claims_file = "data/formatted_claims_all.txt", 
                              output_claims_aggregated_file = "data/formatted_claims_county.txt") {
